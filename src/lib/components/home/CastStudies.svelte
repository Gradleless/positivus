<section class="space-grotesk-400 px-6 py-12 md:px-40">
	<div class="mb-16 flex flex-col items-center gap-x-8 md:flex-row text-center">
		<h2 class="rounded-xl bg-[#B9FF66] p-1 text-4xl font-bold">Case Studies</h2>
	...
	<!-- First Row -->
	<!-- Second Row -->
	<div class="grid grid-cols-1 gap-8 rounded-[45px] bg-[#191A23] px-10 py-24 md:grid-cols-3">
		<div class="flex flex-col justify-between max-lg:border-b lg:border-r p-4 text-white">
			<!-- need a #each here -->
			<div>
				<p class="mt-4">
			...
			<a href="#learn-more" class="mt-4 flex items-center gap-x-2 hover:underline text-[#B9FF66]">
				<p class="text-[#B9FF66]">Learn More</p>
				<img src="/Arrow 1.png" alt="Case Study" class="h-4 w-4 object-cover" />
			</a>
		</div>
		<div class="max-lg:border-b lg:border-r p-4 text-white">
			<p class="mt-4">
